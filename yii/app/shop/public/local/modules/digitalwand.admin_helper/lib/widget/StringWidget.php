...
class StringWidget extends HelperWidget
{
	...
	protected function getEditHtml()
	{
		...
		if ($this->getSettings('TRANSLIT')) {
			...
			$uniqId = $className . '_' . $this->getCode();
			$nameId = 'name_link_' . $uniqId;
			$linkedFunctionName = 'set_linked_' . $this->entityName . '_CODE';//FIXME: hardcode here!!!

			$pkVal = $this->data['ID'] ?? '_new_';
			...
			$link =
				...
				$nameId .
				'" title="' .
				Loc::getMessage("IBSEC_E_LINK_TIP") .
